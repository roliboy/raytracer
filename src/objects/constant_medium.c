...
bool constant_medium_hit(constant_medium* cm, ray* r, float t_min, float t_max, hit* record) {
    hit rec1, rec2;
...
bool constant_medium_bounding_box(constant_medium* cm, float time0, float time1, bounding_box* box) {
