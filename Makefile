...
build/constant_medium.o: objects/constant_medium.c objects/constant_medium.h
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $< -c

build/isotropic.o: materials/isotropic.c materials/isotropic.h
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $< -c
