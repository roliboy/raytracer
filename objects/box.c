    ...
    return (object) {
        ...
        .data = (object_data) {
            .box = (box) {
                ...
                .back = (xy_rectangle) {min.x, max.x, min.y, max.y, max.z, mat}, //front
                .right = (yz_rectangle) {min.y, max.y, min.z, max.z, min.x, mat}, //right
                .left = (yz_rectangle) {min.y, max.y, min.z, max.z, max.x, mat}, //left
                .bottom = (zx_rectangle) {min.z, max.z, min.x, max.x, min.y, mat}, //bot
                .top = (zx_rectangle) {min.z, max.z, min.x, max.x, max.y, mat}, //top
                .mat = mat
            }
        }
    };
